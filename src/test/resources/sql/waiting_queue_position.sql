...
VALUES (1, UUID_TO_BIN(REPLACE('01b8f8a1-6f8c-7b6e-87c3-234a3c15f77e', '-', '')), 1, 'WAITING', 0),
       (2, UUID_TO_BIN(REPLACE('01b8f8a1-6f8c-7b6e-87c3-234a3c15f78f', '-', '')), 2, 'AVAILABLE',
        1704759600), -- 현재 시간 + 3분
       ...
       (5, UUID_TO_BIN(REPLACE('01b8f8a1-6f8c-7b6e-87c3-234a3c15f7bb', '-', '')), 5, 'AVAILABLE',
        1704759300), -- 현재 시간 + 4분
       ...
       (8, UUID_TO_BIN(REPLACE('01b8f8a1-6f8c-7b6e-87c3-234a3c15f7e1', '-', '')), 8, 'AVAILABLE',
        1704758700), -- 현재 시간 + 2분
